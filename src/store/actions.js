...
import { savaSearch, deleteSearch, clearSearch, savaPlay, savaFavorite, deleteFavorite } from 'common/js/cache'
...
export const savaPlayHistory = function ({commit}, song) {
  commit(types.SET_PLAY_HISTORY, savaPlay(song))
}
