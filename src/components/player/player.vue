        ...
        <div class="bottom">
          ...
          <div class="operators">
            ...
            <div class="icon i-right">
              <i class="icon" @click="toggleFavorite(currentSong)" :class="getFavoriteitemIcon(currentSong)"></i>
            </div>
          </div>
        </div>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      middleTouchStart(e) {
        ...
        this.touch.touchX = touch.pageX
        this.touch.touchY = touch.pageY
      },
      middleTouchMove(e) {
        ...
        const touch = e.touches[0]
        const deltaX = touch.pageX - this.touch.touchX
        const deltaY = touch.pageY - this.touch.touchY
